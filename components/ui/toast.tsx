...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 left-1/2 transform -translate-x-1/2 z-[100] max-h-screen w-full p-4 max-w-[380px] md:max-w-[520px]",
      className
    )}
    {...props}
  />
...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(toastVariants({ variant }), "-mb-16", className)}
      {...props}
    />
  );
});
